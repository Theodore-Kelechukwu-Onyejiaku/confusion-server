...
.put(cors.corsWithOptions, authenticate.verifyUser,(req, res, next) => {
    ...
    .then((dish) => {
        if (dish != null && dish.comments.id(req.params.commentId) != null) {
            ...
            let id2 = dish.comments.id(req.params.commentId).author;

            if(!(id1.equals(id2))){
                console.log("This is not the user!")
                err = new Error("You are no authorized to update this comment!");
                err.status = 403;
                return next(err)
            }
...
.delete(cors.corsWithOptions, authenticate.verifyUser,(req, res, next) => {
    ...
    .then((dish) => {
        if (dish != null && dish.comments.id(req.params.commentId) != null) {
            ...
            if(!(id1.equals(id2))){
                console.log("This is not the user!")
                err = new Error("You are no authorized to Delete this comment!");
                err.status = 403;
                return next(err)
            }
